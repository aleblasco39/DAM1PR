...
public class Ejercicio1 {
	...
	public static void main(String[] args) {// Se generan 20 números aleatorios de tipo entero entre -10 y 10 almacenándolos en un vector.
		...
		System.out.println("-----------------------------------------------------------------------------------------------------------------------------------------------------");
		System.out.println("El numero de numeros iguales a la media es de "+med+", los numeros inferiores a la media es de "+inf+" y los números superiores a la media es de "+sup);
	}
