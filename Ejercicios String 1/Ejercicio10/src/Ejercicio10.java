...
public class Ejercicio10 {// Escribir un programa que lea una frase (máximo 60 caracteres) y diga cuántas letras
	...
	public static void main(String[] args) {
		...
		while (comodin<1) { //Así controlamos que no sea más de 60 carácteres
			if (60<texto.length()) {
